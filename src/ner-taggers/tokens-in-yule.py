...
for index,row in data.iterrows():
    ...
    #sentence = "A mile beyond that city are two roads, one leading westward through Cathay, the other southward to the great province of Manji."
    ...
    common = common_1gram + common_alternative_1gram + common_bigram + common_alternative_bigram + common_trigram + common_alternative_trigram
    print(common)
    ...
    common = ','.join([str(elem) for elem in common])
    #location_list.append(location)
    #person_list.append(person)
    common_list.append(common)
    count = count + 1

data['common'] = common_list


writefile = datapath / 'data/hugh-murray/chapter1/chapter1-common.csv'
