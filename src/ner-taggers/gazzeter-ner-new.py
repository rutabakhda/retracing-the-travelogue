...
# Input individual index files
 #datapath / 'data/final-list.txt.csv'
...
readfile = datapath / 'results/hugh-murray/part2/processed/part2-annotated.csv'
...
writefile = datapath / 'results/hugh-murray/part2/NER/gazetteer.csv'
